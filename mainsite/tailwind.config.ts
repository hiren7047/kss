...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['Poppins', 'Noto Sans Gujarati', 'Noto Sans Devanagari', 'sans-serif'],
        serif: ['Playfair Display', 'Noto Sans Gujarati', 'Noto Sans Devanagari', 'serif'],
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(22, 95%, 55%, 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(22, 95%, 55%, 0.5)" },
        },
        "count-up": {
      ...
      backgroundImage: {
        ...
        'sunrise-gradient': 'var(--gradient-sunrise)',
